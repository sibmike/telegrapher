...
\end{equation}
observed hard failures before that cap can accommodate $q$ distinct discovered modes. Adding $\Delta q$ modes to the discovered catalogue therefore takes at least $\exp(\Delta q / \sigma_D)$ times more failures, under Postulate~\ref{post:logmode} alone.
\end{corollary}
