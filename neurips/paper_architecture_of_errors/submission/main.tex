...
\section{Proof of Proposition~\ref{prop:nounidict}: No Universal Finite Intervention Dictionary}
...
\section{Derivation of Proposition~\ref{prop:budget}: Patch-Local Intervention Budget}
...
\section{Sequence-Level Reliability Derivation}
\label{app:seq-level}
...
\section{Why these are propositions rather than unconditional theorems}
