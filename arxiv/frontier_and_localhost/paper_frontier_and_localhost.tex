...
G.7). \textbf{Poisoned memory} is the dominant security risk:
...
dominant ecosystem risk: the Leaderboard Illusion
...
under differential training-data access --- a structural overfitting
pathway, not benchmark error; eval suites are themselves patch-plastic
artifacts and must survive Goodhart's Law. Ong et al.
(\citeproc{ref-ong2026harnesseval}{2026}) extend the diagnosis to
