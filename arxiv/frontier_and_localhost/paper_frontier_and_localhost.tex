...
\textbf{S5 --- Orchestration} & 19 & 2.68 & MAE & Multi-agent topologies
exist (LangGraph, AutoGen, CrewAI) but topology \emph{evolution} is
rare; production rarely exposes governed promotion paths for emerging
agent graphs \\
...
68\% at 500 instructions. Lost-in-the-middle (Liu et al., 2023) supplies
...
Body text refers to the system as SSGM; the paper itself does not use
that acronym.
